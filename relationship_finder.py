# Finds relative pairs (of any relationship type) from simulated pedigree data across
# multiple generations, using a set-based pandas.merge approach for high performance.
# (An older multiprocessing graph-traversal implementation is archived at
# Scripts/Archive/SimulationFunctions_legacy/find_relative.py.)
